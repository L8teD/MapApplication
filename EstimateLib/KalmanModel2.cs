...
//            G[7, 3] = C[3, 3];
//        }
//        private void InitW(InitErrors initErrors, Randomize randomize)
//        {
...
//            H[4, 4] = 1.0;
//        }
//        private void InitZ(Point point, Velocity velocity, EarthModel earth, InitErrors initErrors, Randomize randomize)
//        {
...
//            double[] _Z_sns = new double[]
//            {
//                _point.lon + snsErrors[1] + noise_sns * randomize.GetRandom(),
//                _point.lat + snsErrors[2] + noise_sns * randomize.GetRandom(),
//                velocity.E + snsErrors[3] + noise_sns * randomize.GetRandom(),
//                velocity.N + snsErrors[4] + noise_sns * randomize.GetRandom()
//            };
...
//        }
//        public void Model(InitErrors initErrors, Parameters parameters, Matrix C, double dt, Randomize randomize)
//        {
//            if (X == null)
//            {
...
//            InitG(C);
//            InitW(initErrors, randomize);


//            X_dot = F * X + G * W;

//            InitH(parameters.point, parameters.earthModel, parameters.absOmega, parameters.velocity);
//            InitZ(parameters.point, parameters.velocity, parameters.earthModel, initErrors, randomize);
