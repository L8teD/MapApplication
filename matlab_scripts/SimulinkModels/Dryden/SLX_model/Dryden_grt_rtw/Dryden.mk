...
MODEL                = Dryden
MODULES              = rt_logging.c Dryden.c Dryden_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_main.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Dryden.exe
MAKEFILE             = Dryden.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = B:/Ucheba/Диплом/Soft_from_work/matlab_scripts/SimulinkModels/Dryden/SLX_model
S_FUNCTIONS_LIB      = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 5
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Dryden_ref.rsp
