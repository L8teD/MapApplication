...
typedef struct {
  ...
  real_T RandomNumber1;                /* '<Root>/Random Number1' */
  real_T RandomNumber2;                /* '<Root>/Random Number2' */
} B_Dryden_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T NextOutput;                   /* '<Root>/Random Number' */
  real_T NextOutput_g;                 /* '<Root>/Random Number1' */
  real_T NextOutput_j;                 /* '<Root>/Random Number2' */
  uint32_T RandSeed;                   /* '<Root>/Random Number' */
  uint32_T RandSeed_e;                 /* '<Root>/Random Number1' */
  uint32_T RandSeed_m;                 /* '<Root>/Random Number2' */
} DW_Dryden_T;
...
/* Block signals (default storage) */
extern B_Dryden_T Dryden_B;

/* Continuous states (default storage) */
extern X_Dryden_T Dryden_X;

/* Block states (default storage) */
extern DW_Dryden_T Dryden_DW;
