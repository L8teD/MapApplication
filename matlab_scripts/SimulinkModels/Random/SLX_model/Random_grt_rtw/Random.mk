...
MODEL                = Random
MODULES              = rt_logging.c Random.c Random_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_main.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Random.exe
MAKEFILE             = Random.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = B:/Ucheba/Диплом/Soft_from_work/matlab_scripts/SimulinkModels/Random/SLX_model
S_FUNCTIONS_LIB      = 
NUMST                = 1
TID01EQ              = 0
NCSTATES             = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Random_ref.rsp
