...
MODEL                = AproximateModel
MODULES              = rt_logging.c AproximateModel.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_main.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/AproximateModel.exe
MAKEFILE             = AproximateModel.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = B:/Ucheba/Диплом/Soft/matlab_scripts/test_csv
S_FUNCTIONS_LIB      = 
NUMST                = 1
TID01EQ              = 0
NCSTATES             = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = AproximateModel_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/AproximateModel_grt_rtw \
